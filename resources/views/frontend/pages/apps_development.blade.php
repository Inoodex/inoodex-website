...
<body>
  ...
  <section class="svc-hero">
    <img src="{{ asset('frontend/assets/images/about.png') }}" alt="Apps Development" class="svc-hero-bg">
    <div class="svc-hero-overlay"></div>
    <div class="svc-hero-content">
      <h1>Apps <span>Development</span></h1>
      <ul class="svc-breadcrumb">
        <li><a href="{{ url('/') }}">Home</a></li>
        <li class="sep">/</li>
        <li><a href="{{ url('/services') }}">Services</a></li>
        <li class="sep">/</li>
        <li class="active">Apps Development</li>
      </ul>
    </div>
  </section>
  ...
  <section class="svc-top">
    <div class="svc-top-left">
      ...
      <h2 class="svc-heading">Native & Cross-Platform Apps</h2>
    </div>
    <div class="svc-top-right">
      <p class="svc-desc">We offer custom app development services that are designed to meet the specific needs of your business for iOS and Android platforms. From concept to launch, we deliver intuitive, high-performance mobile applications.</p>
    </div>
  </section>
  ...
  <section class="svc-content">
    <div class="svc-content-grid">
      <div class="svc-content-main">
        <p>We offer custom app development services that are designed to meet the specific needs of your business for iOS and Android platforms. From concept to launch, we deliver intuitive, high-performance mobile applications.</p>
        <p>Transform your ideas into powerful mobile apps with InooDex. Let's build scalable, user-friendly applications that drive engagement and growth.</p>
        ...
        <div class="svc-check">
          ...
          <div>
            ...
            <p>We build for both iOS and Android using the latest frameworks, ensuring reach across all devices.</p>
          </div>
        </div>
        <div class="svc-check">
          <div class="svc-check-icon"><i class="fas fa-check"></i></div>
          <div>
            ...
            <p>Intuitive interfaces and seamless user experiences designed to keep your audience engaged.</p>
          </div>
        </div>
        <div class="svc-check">
          <div class="svc-check-icon"><i class="fas fa-check"></i></div>
          <div>
            ...
            <p>Iterative development with regular updates and feedback loops to ensure your app meets expectations.</p>
          </div>
        </div>
        <div class="svc-check">
          <div class="svc-check-icon"><i class="fas fa-check"></i></div>
          <div>
            ...
            <p>Ongoing maintenance, updates, and support to keep your app running smoothly after launch.</p>
          </div>
        </div>
      </div>
  ...
  <section class="svc-why">
    ...
    <div class="svc-why-grid">
      <div class="svc-why-card">
        ...
        <p>Build once, deploy everywhere. iOS and Android with a single codebase.</p>
      </div>
      <div class="svc-why-card">
        <div class="svc-why-card-icon">
        ...
        <h3>UI/UX Design</h3>
        <p>Beautiful, intuitive interfaces that keep users coming back.</p>
      </div>
      <div class="svc-why-card">
        <div class="svc-why-card-icon">
        ...
        <p>Optimized for speed and efficiency across all device types.</p>
      </div>
    </div>
  </section>
    ...
    <div class="svc-faq-grid">
      <div>
        <details class="svc-faq-item" open>
          <summary>What platforms do you develop apps for?</summary>
        ...
        <details class="svc-faq-item">
          <summary>How long does it take to develop a mobile app?</summary>
          <div class="svc-faq-answer">
            <p>Timeline depends on complexity. A simple app takes 2-3 months, while complex enterprise apps may take 6+ months. We provide detailed timelines during the planning phase.</p>
          </div>
        </details>
        <details class="svc-faq-item">
          <summary>Do you provide app store submission support?</summary>
          <div class="svc-faq-answer">
            <p>Yes. We handle the entire submission process for both Apple App Store and Google Play Store, including compliance, screenshots, and metadata.</p>
          </div>
        </details>
        <details class="svc-faq-item">
          <summary>What is the cost of app development?</summary>
          <div class="svc-faq-answer">
            <p>Cost varies based on features, complexity, and platform. We offer transparent quotes after the discovery phase with no hidden charges.</p>
          </div>
        </details>
      </div>
