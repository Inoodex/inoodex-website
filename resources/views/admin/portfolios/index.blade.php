...
@section('admin_content')
    <div class="container-fluid py-5">
        <div class="flex items-center justify-between mb-4">
            <h1 class="h3 font-bold text-gray-900">Portfolio Management</h1>
            <a href="{{ route('admin.portfolios.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">Add New Portfolio</a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($portfolios as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('admin.portfolios.show', $item) }}" class="inline-flex items-center px-3 py-1.5 bg-cyan-500 text-white rounded hover:bg-cyan-600 text-sm">View</a>
                                ...
                                <form action="{{ route('admin.portfolios.destroy', $item) }}" method="POST"
