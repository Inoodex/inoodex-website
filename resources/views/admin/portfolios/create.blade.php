    ...
    <div class="container-fluid py-4">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 bg-blue-600 text-white">
                <h1 class="h5 mb-0">Add Portfolio Item</h1>
            </div>
            <div class="p-6">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.portfolios.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="demo_url" class="block text-sm font-medium text-gray-700 mb-1">Demo URL<span class="text-danger">*</span></label>
