    ...
    <div class="container-fluid py-4">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 bg-blue-600 text-white">
                <h1 class="h5 mb-0">Edit Team Member</h1>
            </div>
            <div class="p-6">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.teams.update', $team->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('name') is-invalid @enderror" value="{{ old('name', $team->name) }}"
                            required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="position" id="position"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('position') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($team->image)
                            <img src="{{ asset('storage/' . $team->image) }}" width="150" alt="team Image">
                        @else
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="bio" id="bio" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('bio') is-invalid @enderror" rows="4">{{ old('bio', $team->bio) }}</textarea>
                        @error('bio')
                            <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        @enderror
                    </div>
