                ...
                <form action="{{ route('admin.themes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="price" id="price" step="0.01"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('price') is-invalid @enderror" value="{{ old('price', 0) }}"
                            required>
                        @error('price')
                            <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="demo_url" id="demo_url"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('demo_url') is-invalid @enderror" value="{{ old('demo_url') }}">
                        @error('demo_url')
                            <div class="mt-1 text-sm text-red-600">{{ $message }}</div>
                        @enderror
                    </div>
