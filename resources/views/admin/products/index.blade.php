...
@section('admin_content')
    <div class="container-fluid py-5">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="{{ route('admin.products.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">Add New Product</a>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($products as $item)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-700">{{ $item->category->name ?? 'N/A' }}</td>
                            <td class="px-4 py-3">
                                @if ($item->image)
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('admin.products.show', $item) }}" class="inline-flex items-center px-3 py-1.5 bg-cyan-500 text-white rounded hover:bg-cyan-600 text-sm">View</a>
                                <a href="{{ route('admin.products.edit', $item) }}" class="inline-flex items-center px-3 py-1.5 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-sm">Edit</a>
