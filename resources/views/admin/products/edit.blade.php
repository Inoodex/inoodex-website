    ...
    <div class="container-fluid py-4">
        <div class="bg-white rounded-lg shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-200 bg-blue-600 text-white">
                <h1 class="h5 mb-0">Edit Product Item</h1>
            </div>
            <div class="p-6">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('name') is-invalid @enderror"
                    ...
                    <div class="mb-3">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">Current Image</label><br>
                        @if ($product->image)
                    ...
                    <div class="mb-3">
                        <label for="image_new" class="block text-sm font-medium text-gray-700 mb-1">Change Image</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="product_url" id="product_url"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none @error('product_url') is-invalid @enderror"
                    ...
                    <a href="{{ route('admin.contacts.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600">Cancel</a>
                </form>
            </div>
        </div>
    </div>
