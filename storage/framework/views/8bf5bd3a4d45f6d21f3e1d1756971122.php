...
<div class="our-services">
  <div style="max-width:1200px;margin:0 auto;padding:0 20px;">
    <div style="display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;margin-bottom:10px;">
      ...
      <div>
        <a href="<?php echo e(url('/services')); ?>" class="services-btn wow fadeInUp" data-wow-delay="0.15s">View All Services</a>
      </div>
    </div>
    ...
    <div class="services-grid">
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.2s">
        ...
        <a href="<?php echo e(url('/software-development')); ?>" class="service-card-link">
          Learn More
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.3s">
        ...
        <a href="<?php echo e(url('/apps-development')); ?>" class="service-card-link">
          Learn More
          <i class="fas fa-arrow-right" style="margin-left:2px;transition:transform 0.3s ease;"></i>
        </a>
      </div>
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.4s">
        ...
        <a href="<?php echo e(url('/web-development')); ?>" class="service-card-link">
          Learn More
          <i class="fas fa-arrow-right" style="margin-left:2px;transition:transform 0.3s ease;"></i>
        </a>
      </div>
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.5s">
        ...
        <a href="<?php echo e(url('/digital-marketing')); ?>" class="service-card-link">
          Learn More
          <i class="fas fa-arrow-right" style="margin-left:2px;transition:transform 0.3s ease;"></i>
        </a>
      </div>
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.6s">
        ...
        <a href="<?php echo e(url('/seo')); ?>" class="service-card-link">
          Learn More
          <i class="fas fa-arrow-right" style="margin-left:2px;transition:transform 0.3s ease;"></i>
        </a>
      </div>
      ...
      <div class="service-card wow fadeInUp" data-wow-delay="0.7s">
        ...
        <p>Creative visuals that engage and captivate your audience. From stunning illustrations to sleek modern designs
          for your brand.</p>
        <a href="<?php echo e(url('/contact')); ?>" class="service-card-link">
          Learn More
          <i class="fas fa-arrow-right" style="margin-left:2px;transition:transform 0.3s ease;"></i>
        </a>
      </div>
...
</div><?php /**PATH C:\laragon\www\inoodex_latest\resources\views/frontend/components/services.blade.php ENDPATH**/ ?>