              ...
              <div class="col-lg-8">
                ...
                <div class="hero-content">
                  ...
                  <div class="section-title">
                    <?php if($slide->subtitle ?? false): ?>
                    <h3><?php echo e($slide->subtitle); ?></h3>
                    <?php else: ?>
                    <h3>✦ Welcome To Inoodex</h3>
                    <?php endif; ?>
                    <h1>
                      <?php echo e($slide->title ?? 'Professional Software Development Company In Bangladesh'); ?>
                  ...
                  <div class="hero-footer">
                    <a href="<?php echo e(url('/contact')); ?>" class="btn-default">
                      <span class="btn-overlay"></span>
                      <span class="btn-text"><?php echo e($slide->button_text ?? "Let's Talk"); ?></span>
                      <!-- SINGLE ARROW ONLY -->
                ...
                <div class="hero-image">
                  <div class="image-wrapper">
                    ...
                    <figure style="margin: 0; position: relative; z-index: 0; border-radius: 16px; overflow: hidden;">
                      <?php if(!empty($slide->image) && file_exists(public_path('storage/' . $slide->image))): ?>
                      <img src="<?php echo e(asset('storage/' . $slide->image)); ?>" alt="<?php echo e($slide->title ?? 'Hero Image'); ?>"
                        class="img-fluid">
                      <?php else: ?>
                      <img src="<?php echo e(asset('frontend/assets/images/hero-img.jpg')); ?>" alt="Inoodex" class="img-fluid">
                      <?php endif; ?>
                    </figure>
                  </div>
...
</html><?php /**PATH C:\laragon\www\inoodex_latest\resources\views/frontend/layout/hero2.blade.php ENDPATH**/ ?>