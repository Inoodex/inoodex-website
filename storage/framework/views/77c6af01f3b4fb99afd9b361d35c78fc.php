      ...
      <nav style="display: flex; align-items: center; justify-content: space-between; height: 70px;">
        ...
        <a class="logo-wrap"
          ...
          <div style="position: relative; display: flex; align-items: center; justify-content: center;">
            ...
            <img id="navLogo" src="<?php echo e(asset('frontend/assets/images/logo.png')); ?>" alt="Inoodex"
        ...
        <div id="desktopMenu" style="display: none; align-items: center;">
          <ul style="display: flex; align-items: center; gap: 2px; list-style: none; margin: 0; padding: 0;" id="menu">
              ...
              <div class="services-dropdown"
                ...
                <div
                  ...
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/software-development')); ?>">Software Development</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/apps-development')); ?>">Apps Development</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/web-development')); ?>">Web Development</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/digital-marketing')); ?>">Digital Marketing</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/seo')); ?>">SEO</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/data-analysis')); ?>">Data Analysis</a>
                </div>
              </div>
            </li>
            <li style="position: relative;">
              ...
              <div class="Products-dropdown"
                ...
                <div
                  ...
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href=" <?php echo e(url('/inventory.inoodex.com')); ?>">Inventory Management</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/sms.inoodex.com')); ?>">POS Software</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/electronicspartsbd.com')); ?>">E-Commerce</a>
                  <a style="display: flex; align-items: center; padding: 8px 16px; font-size: 14px; color: #d1d5db; text-decoration: none; transition: all 0.3s;"
                    href="<?php echo e(url('/education.inoodex.com')); ?>">School Management</a>
                </div>
              </div>
            </li>
            ...
            <li>
              <a class="nav-link"
                style="padding: 8px 14px; font-size: 14px; font-weight: 500; color: #9ca3af; border-radius: 10px; text-decoration: none; transition: all 0.3s; position: relative;"
                href="<?php echo e(url('/themes')); ?>">Themes</a>
            </li>
            <li>
              <a class="nav-link"
                style="padding: 8px 14px; font-size: 14px; font-weight: 500; color: #9ca3af; border-radius: 10px; text-decoration: none; transition: all 0.3s; position: relative;"
          ...
          <li>
            ...
            <ul class="mobile-submenu"
              ...
              <li><a
                  ...
                  href="<?php echo e(url('/software-development')); ?>"
                  onmouseover="this.style.background='rgba(255,255,255,0.04)'; this.style.color='#ffffff'"
...
</script><?php /**PATH C:\laragon\www\inoodex_latest\resources\views/frontend/layout/headerNav.blade.php ENDPATH**/ ?>