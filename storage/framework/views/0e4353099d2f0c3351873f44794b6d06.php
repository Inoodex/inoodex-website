    ...
    <div class="why-cards-grid">
      ...
      <div class="why-card">
        ...
        <div class="why-icon-box">
          <img src="<?php echo e(asset('frontend/assets/images/icon-whyus-1.svg')); ?>" alt="Innovation" style="width: 38px; height: 38px; filter: brightness(0) invert(1);">
        </div>
        <h3>Innovation</h3>
      ...
      <div class="why-card">
        <div class="why-card-top-bar"></div>
        <div class="why-icon-box">
          <img src="<?php echo e(asset('frontend/assets/images/icon-whyus-2.svg')); ?>" alt="Quality-Focused" style="width: 38px; height: 38px; filter: brightness(0) invert(1);">
        </div>
      ...
      <div class="why-card">
        <div class="why-card-top-bar"></div>
        <div class="why-icon-box">
          <img src="<?php echo e(asset('frontend/assets/images/icon-whyus-3.svg')); ?>" alt="Value for Money" style="width: 38px; height: 38px; filter: brightness(0) invert(1);">
        </div>
...
<?php /**PATH C:\laragon\www\inoodex_latest\resources\views/frontend/components/why_choose_us.blade.php ENDPATH**/ ?>