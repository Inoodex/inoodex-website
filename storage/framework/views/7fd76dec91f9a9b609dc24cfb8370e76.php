  ...
  <div class="latest-news">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div style="display: grid; grid-template-columns: 1fr; gap: 30px; margin-top: 20px;">
        ...
        <div class="blog-item" style="border-left: 4px solid <?php echo e($blogColors[$index % count($blogColors)]); ?>;"
          ...
          <div style="flex: 0 0 40%; max-width: 40%; overflow: hidden; position: relative;">
            <div style="position: relative; overflow: hidden; min-height: 200px;">
              <figure style="margin: 0; overflow: hidden;">
                <img src="<?php echo e(asset('storage/' . $blog->image)); ?>" alt="<?php echo e($blog->title); ?>" class="blog-image">
              </figure>
              <div
          ...
          <div style="flex: 0 0 60%; max-width: 60%; padding: 30px 35px;">
            <div class="blog-content">
              ...
              <div
                ...
                <span
                  style="color: #f4a637; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;"><?php echo e($blog->category ?? 'Technology'); ?></span>
              </div>
              ...
              <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 12px;">
                <span style="color: #6b7280; font-size: 13px;">
                  ...
                  <?php echo e($blog->created_at ? $blog->created_at->format('M d, Y') : 'Jan 01, 2025'); ?>
              ...
              <p style="color: #9ca3af; font-size: 15px; line-height: 1.8; margin-bottom: 15px;">
                <?php echo e(Str::limit(strip_tags($blog->description ?? $blog->content ?? ''), 120)); ?>
...
</html><?php /**PATH C:\laragon\www\inoodex_latest\resources\views/frontend/components/blog.blade.php ENDPATH**/ ?>